...
<article class="item__full-news ignore-select">
	...
	<div id="col__main-with--sidebar">
		...
		<!-- advanse -->
		<div class="dashboard__container row"><img src="{THEME}/images/special2.jpg" alt="Реклама"></div>
		<!-- end advanse -->
		...
		<div class="dashboard__container row">
			<div class="content__sidebar-section col__12">
				...
				[xfgiven_originaltitle]<div class="content__sidebar-subtitle">[xfvalue_originaltitle]</div>[/xfgiven_originaltitle]
			</div>
		</div>
	...
	<div id="main__bottom-comments" class="col__12">
		<div class="container">
			<div class="row">
				<!-- edvance -->
				<div class="dashboard__container col__12">
					<img src="{THEME}/images/special3.jpg" alt="Реклама">
				</div>
				<!-- end edvance -->
